...
export const Selectors=Object.freeze({state,activities,tasks,openTasks,overdueTasks,dueSoonTasks,byReference,registryFiles,comments,approvals,dispatches,search,paginate});
