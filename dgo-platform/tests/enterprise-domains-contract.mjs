...
for(const key of ['correspondence','operations','registryFiles','fileMovements','registryMinutes','escalations','notifications','dispatches'])assert.match(state,new RegExp(key+':\\[\\]'));
